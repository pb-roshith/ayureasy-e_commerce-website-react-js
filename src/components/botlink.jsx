  ...
  return (
    <>
        <div style={{backgroundColor:'#00FF00', marginBottom:'50px', marginTop:'110px'}}>
            <p style={{color:'#fff'}} className='display-3 text-center'>TRY OUR CHATBOT</p>
            <p style={{color:'#fff'}} className='text-center lead'>for suggestions and recommendation</p>
           <Container>
            <p style={{color:'#fff'}} className='text-center display-6'>An Ayurvedic chatbot for symptom matching and recommend appropriate Ayurvedic medicines, along with AI-generated short descriptions.</p>
